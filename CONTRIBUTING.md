...
Welcome to the contributor guide of pybergertable.
...
If you experience bugs or general issues with pybergertable, please have a look
...
You can help improve the documentation of pybergertable by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/pybergertable.git
   cd pybergertable
   ```
